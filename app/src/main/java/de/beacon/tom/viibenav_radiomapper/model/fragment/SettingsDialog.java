...
import de.beacon.tom.viibenav_radiomapper.model.Setup;
...
public class SettingsDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        FP_AMT_THRESH.setText(""+ Setup.MEASUREMENT_AMT_THRESHOLD);
        FSPL_CONST.setText(""+Setup.FSPL_ELEMENT);
        OF_AMT_THRESH.setText(""+Setup.ON_THE_FLY_AMT_THRESHOLD);
